class UserModel {
  ...
  final int? score; // Очки пользователя
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'score': score, // Добавляем очки в JSON
    };
  }
  ...
  UserModel copyWith({
    ...
    int? score, // Добавляем очки в copyWith
  }) {
    return UserModel(
      ...
      score: score ?? this.score, // Добавляем очки в copyWith
    );
  }
}
