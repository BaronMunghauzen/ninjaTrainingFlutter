...
class _AchievementsScreenState extends State<AchievementsScreen> {
  ...
  Future<void> _loadAchievements() async {
    ...
    print('Начинаем загрузку достижений...');
    ...
    if (provider.achievements.isEmpty) {
      print('API не вернул данные, загружаем mock достижения');
    ...
    print('Загружено ${provider.achievements.length} достижений');
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              const String demoUserUuid = 'demo-user-123';
              context.read<AchievementProvider>().loadUserAchievementsByUuid(demoUserUuid);
            },
            tooltip: 'Загрузить достижения пользователя',
          ),
          IconButton(
            icon: const Icon(Icons.smart_toy, color: Colors.white),
            onPressed: () => context.read<AchievementProvider>().loadMockAchievements(),
            tooltip: 'Mock данные',
          ),
        ],
      ),
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: achievement.isUnlocked ? AppColors.primary : Colors.grey[400]!,
            width: 2,
          ),
        ),
        child: Column(
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 12,
                  fontWeight: FontWeight.bold,
                  color: achievement.isUnlocked ? Colors.white : Colors.grey[700],
                ),
                textAlign: TextAlign.center,
                maxLines: 2,
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _selectedCategory == null ? AppColors.primary : Colors.grey[300],
          ...
          final count = achievements.where((a) => a.category == category).length;
